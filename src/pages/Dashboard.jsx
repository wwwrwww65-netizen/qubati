    ...
    <div className="fade-in">
      <div className="ticker-wrapper">
        <div className="ticker-track">
          <span className="ticker-text">الشوافي لخدمات النقل والسفريات والتسويق والسياحي اينما تكون نحن معك .. صنعاء - القبيطة - الراهدة - تعز - الاحكوم - حيفان الاعبوس -الاعروق الاغبرة - عدن - الحديدة</span>
          <span className="ticker-text">الشوافي لخدمات النقل والسفريات والتسويق والسياحي اينما تكون نحن معك .. صنعاء - القبيطة - الراهدة - تعز - الاحكوم - حيفان الاعبوس -الاعروق الاغبرة - عدن - الحديدة</span>
        </div>
      </div>
